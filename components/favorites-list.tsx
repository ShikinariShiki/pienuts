...
export function FavoritesList({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="flex-1">
                <p className="text-xs font-medium text-pink-700 dark:text-pink-300">
                  Kesayangan Pien <span className="text-pink-400">💖💖</span>
                </p>
              </div>
                ...
                {favoriteAccounts.map((account) => (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="bg-pink-400 hover:bg-pink-500 text-white rounded-full p-1.5 transition-colors"
                    >
            ...
            <div className="mt-3 pt-3 border-t border-pink-100 dark:border-[#2d2d42] text-center">
              <p className="text-xs text-pink-500 dark:text-pink-400">Pien's favorite Twitter friends ♡</p>
            </div>
          </div>
        </motion.div>
      )}
