...
import { Menu, X, Home, User, Heart, Star, MessageSquare } from "lucide-react"
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              className="fixed top-0 right-0 h-full w-64 bg-white dark:bg-[#16213e] z-50 shadow-lg"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
              transition={{ type: "spring", damping: 25 }}
            >
              <div className="flex justify-between items-center p-4 border-b border-pink-200 dark:border-pink-800/30">
